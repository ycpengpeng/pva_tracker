...
int main(int argc, char** argv) 
{
    ...
    ros::init(argc, argv, "square_fly_test_on_real_drone");
    ros::NodeHandle nh;
...
//             }
        ...
        if(take_off_flag==1)
        {
            ...
            if(change_flag==1)
            {
                 //std::cout<<"point_matrix； aaaaaaaaa"<<std::endl;
            ...
            //std::cout<<"square_count: "<<square_count<<std::endl;
            setPVA(p_t.row(square_count), v_t.row(square_count), a_t.row(square_count), yaw_set);// a_t.row(i));
            
            std::cout<<"(p_t.row(square_count): "<<p_t.row(square_count)<<std::endl;

            // std::cout<<"v_t: "<<v_t<<std::endl;
            // std::cout<<"a_t: "<<a_t<<std::endl;

            //std::cout<<"point_matrix； sssssss"<<std::endl;
            ...
            {
                //std::cout<<"point_matrix； adadadadad"<<std::endl;
