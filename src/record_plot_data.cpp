//
// Created by pengpeng on 2/10/21.
//
...
void pred_cb(const pva_tracker::input::ConstPtr& msg)
{
    ...
    predict[2]=msg->pred_z;
    predict[3]=msg->pred_vx;
    predict[4]=msg->pred_vy;
    predict[5]=msg->pred_vz;
...
int main(int argc, char **argv)
{
    ...
    std::string file="/home/pengpeng/catkin_ws/record_plot_data/plot_data9_nn.csv";
